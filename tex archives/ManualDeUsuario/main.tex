...
\begin{titlepage}
    ...
    {\huge\bfseries \textit{Odally | Blog}\par}
    \vspace{1.5cm}
...
\begin{itemize}
    ...
    \item Usuario: sergio | Contraseña: admin123
\end{itemize}
...
\\
\textbf{Nombre:} & Sergio Leonardo Moreno Granado \\
\textbf{Código:} & 20242020091 \\
\textbf{Email:} & slmorenog@udistrital.edu.co \\
\end{tabular}
...
\url{https://github.com/slmorenog-ud/AdvancedFinalProject}
